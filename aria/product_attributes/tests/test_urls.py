...
class TestProductAttributesInternalUrls:
    def test_url_color_list_internal_api(self) -> None:
        ...
        """
        url = reverse("api-internal-1.0.0:product-attributes-colors")
    ...
    def test_url_shape_list_internal_api(self) -> None:
        ...
        """
        url = reverse("api-internal-1.0.0:product-attributes-shapes")
    ...
    def test_url_variant_list_internal_api(self) -> None:
        ...
        """
        url = reverse("api-internal-1.0.0:product-attributes-variants")
    ...
    def test_url_variant_create_internal_api(self) -> None:
        ...
        """
        url = reverse("api-internal-1.0.0:product-attributes-variants-create")
