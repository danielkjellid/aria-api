...
from aria.core.viewsets import LogoutAndBlacklistRefreshTokenForUserView, MyTokenObtainPairView
...
urlpatterns = [
    ...
    path('token/blacklist/', LogoutAndBlacklistRefreshTokenForUserView.as_view(), name='token-blacklist'),
]
