...
class TestAPIRenderers:
    def test_orjson_renderer(self) -> None:
        """
        Test that the orjson renderer renders content as expected.
        """
        ...
        # We don't expect orjson to change anything about the returned response,
        # so it should be the same as the data once loaded.
