# Generated by Django 4.0.6 on 2022-08-19 12:27
...
class Migration(migrations.Migration):
    ...
    replaces = [('users', '0001_initial'), ('users', '0002_alter_user_disabled_emails'), ('users', '0003_alter_user_managers_alter_user_unique_together_and_more')]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('disabled_emails', models.BooleanField(default=False, help_text='Decides if a user receives email from us. Typically used if we do not want a user to receive marketing (competitors).')),
