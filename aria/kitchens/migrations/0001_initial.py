    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('decor_variants', models.ManyToManyField(blank=True, related_name='kitchen_decor', to='aria.kitchens.Decor')),
                ('exclusive_variants', models.ManyToManyField(blank=True, related_name='kitchen_exclusive', to='aria.kitchens.ExclusiveColor')),
                ('laminate_variants', models.ManyToManyField(blank=True, related_name='kitchen_decor', to='aria.kitchens.LaminateColor')),
                ('plywood_variants', models.ManyToManyField(blank=True, related_name='kitchen_plywood', to='aria.kitchens.Plywood')),
                ('silk_variants', models.ManyToManyField(blank=True, related_name='kitchen_silk', to='aria.kitchens.SilkColor')),
                ('supplier', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='supplier', to='suppliers.Supplier')),
                ('trend_variants', models.ManyToManyField(blank=True, related_name='kitchen_decor', to='aria.kitchens.TrendColor')),
            ],
            options={
