...
class TestProductSizesSelectors:
    def test_selector_size_list_from_mapped_values(self, django_assert_max_num_queries):
        ...
        size_values_to_map = [
            {"width": 20.0, "height": 40.0, "depth": 10.0, "circumference": None},
            {"width": 30.0, "height": 40.0, "depth": 5.0, "circumference": None},
            {"width": 20.0, "height": 10.0, "depth": 5.0, "circumference": None},
            {"width": 25.0, "height": 35.0, "depth": 12.0, "circumference": None},
            {"width": 80.5, "height": 39.0, "depth": 12.0, "circumference": None},
            {"width": None, "height": None, "depth": None, "circumference": 30.0},
            {"width": None, "height": None, "depth": None, "circumference": 30.0},
            {"width": None, "height": None, "depth": None, "circumference": 40.0},
            {"width": None, "height": None, "depth": None, "circumference": 14.0},
        ]

        expected_output = [
            ProductSizeRecord.construct(
                id=size_8.id,
                width=None,
                height=None,
                depth=None,
